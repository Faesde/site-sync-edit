...
const features = [
  { icon: Phone, title: "Ligações Automáticas", description: "Dispare ligações em massa" },
  { icon: Mic, title: "Voz Personalizada", description: "Grave ou use text-to-speech" },
  { icon: Zap, title: "Automações", description: "Gatilhos de ligação automática" },
  { icon: Clock, title: "Agendamento", description: "Programe ligações" },
  { icon: BarChart3, title: "Relatórios", description: "Acompanhe atendimentos" },
];
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-sm font-medium text-white">Voz/Ligação Marketing</span>
            </motion.div>
            ...
            >
              Marketing por{" "}
              <span className="text-accent">Voz e Ligações</span>
            </motion.h1>
